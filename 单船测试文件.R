...
NMVOCtable = fread('~/R/AIS_Processing/carbon-main/data/IMO4_table/IMO4_table_61_NMVOC_EF.csv')
      ...
      aship=fread(paste("/Users/mizexin/AIS/2019_year_container/566673000.csv",sep = ''),select = c('mmsi','time','speed','lon','lat'),
   ...
   #一氧化碳
    ...
    # fwrite(cbind(test0),paste('/Volumes/Samsung\ SSD/single.csv',sep = ''))
# 