...
ship0=ship1[,list(.N,hours=round(sum(dur)/3600,2),distnm=round(sum(dist)/1852,2)),list(mmsi,SHIP_IMO=imo,speed=speedid,hour,yhour,day,week,month,year)]
